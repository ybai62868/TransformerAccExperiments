...
scripted_model = torch.jit.trace(model.forward, (src, tgt)).eval()
...
input_name0 = "0"
input_name1 = "1"
shape_list = [(input_name0, src.shape), (input_name1, tgt.shape)]
